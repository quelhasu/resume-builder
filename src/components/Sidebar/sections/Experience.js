...
import { createExp, deleteExp, modifyExp, moveExp } from '../../../redux/experiences'
    ...
    <div>
      <Card title="Work Experiences">
        {experiences.map((item, index) => (
          <Form key={item.key} item={item} collapsed={true} modify={true} index={index} arrLength={experiences.length} />
        ))}
